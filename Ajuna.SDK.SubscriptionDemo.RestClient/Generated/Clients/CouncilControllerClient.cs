...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Generated.Clients
{
   ...
   public sealed class CouncilControllerClient : BaseClient, ICouncilControllerClient
   {
      ...
      public async Task<EnumCall> GetProposalOf(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendRequestAsync<EnumCall>(_httpClient, "council/proposalof", Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCouncil.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.ProposalOf", Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCouncil.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "council/voting", Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCouncil.CouncilStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.Voting", Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCouncil.CouncilStorage.VotingParams(key));
      }
