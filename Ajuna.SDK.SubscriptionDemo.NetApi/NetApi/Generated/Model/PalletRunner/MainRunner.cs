...
namespace Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletRunner
{
    ...
    public sealed class RunnerStorage
    {
        ...
        public RunnerStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Runner", "Runners"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState)));
        ...
        ///  Stores a map of the runners with its configuration and state
        /// </summary>
        public async Task<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState> Runners(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = RunnerStorage.RunnersParams(key);
            return await _client.GetStorageAsync<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState>(parameters, token);
        }
