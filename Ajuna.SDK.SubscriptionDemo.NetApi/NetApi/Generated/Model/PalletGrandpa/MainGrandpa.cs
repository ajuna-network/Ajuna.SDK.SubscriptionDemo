...
namespace Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            return await _client.GetStorageAsync<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState>(parameters, token);
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            return await _client.GetStorageAsync<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange>(parameters, token);
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
