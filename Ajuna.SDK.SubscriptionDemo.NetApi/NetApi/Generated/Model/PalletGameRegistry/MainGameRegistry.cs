...
namespace Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGameRegistry
{
    ...
    public sealed class GameRegistryStorage
    {
        ...
        public GameRegistryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GameRegistry", "Players"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128}, typeof(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
        }
        ...
        /// >> PlayersParams
        /// </summary>
        public static string PlayersParams(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
        {
        ...
        /// >> Players
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> Players(Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key, CancellationToken token)
        {
    ...
    public sealed class GameRegistryCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method AckGame(BaseVec<Ajuna.NetApi.Model.Types.Primitive.U32> game_ids, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 shard_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method FinishGame(Ajuna.NetApi.Model.Types.Primitive.U32 game_id, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 winner, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 shard_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(game_id.Encode());
