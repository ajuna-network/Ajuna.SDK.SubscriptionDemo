...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Test.Generated
{
   ...
   public class MatchmakerControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletAjunaMatchmaker.BracketRange GetTestValue2()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletAjunaMatchmaker.BracketRange result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletAjunaMatchmaker.BracketRange();
      ...
      public async System.Threading.Tasks.Task TestBrackets()
      {
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletAjunaMatchmaker.BracketRange mockupValue = this.GetTestValue2();
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletAjunaMatchmaker.BracketRange rpcResult = await rpcClient.GetBrackets(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestPlayers()
      {
         ...
         // Construct new RPC client to test with.
         MatchmakerControllerClient rpcClient = new MatchmakerControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 mockupValue = this.GetTestValue4();
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 rpcResult = await rpcClient.GetPlayers(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 GetTestValue7()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32();
         result.Value = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.Base.Arr32U8();
      ...
      public async System.Threading.Tasks.Task TestPlayerQueue()
      {
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 mockupKey = this.GetTestValue7();
