...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Test.Generated
{
   ...
   using Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa;
   ...
   public class GrandpaControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState GetTestValue2()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState();
         result.Create(this.GetTestValueEnum<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredState>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestState()
      {
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState mockupValue = this.GetTestValue2();
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.EnumStoredState rpcResult = await rpcClient.GetState();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange GetTestValue4()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange();
         result.ScheduledAt = this.GetTestValueU32();
         result.Delay = this.GetTestValueU32();
         result.NextAuthorities = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.WeakBoundedVecT2();
      ...
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.WeakBoundedVecT2 GetTestValue5()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.WeakBoundedVecT2 result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.WeakBoundedVecT2();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public, Ajuna.NetApi.Model.Types.Primitive.U64>>();
         result.Value.Create(new Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public, Ajuna.NetApi.Model.Types.Primitive.U64>[] {
                  this.GetTestValue6()});
         return result;
      }
      public Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public, Ajuna.NetApi.Model.Types.Primitive.U64> GetTestValue6()
      {
         Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public, Ajuna.NetApi.Model.Types.Primitive.U64> result;
         result = new Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public, Ajuna.NetApi.Model.Types.Primitive.U64>();
         result.Create(this.GetTestValue7(), this.GetTestValueU64());
         return result;
      }
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public GetTestValue7()
      {
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public result;
         result = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpFinalityGrandpa.Public();
         result.Value = new Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.Public();
         result.Value = this.GetTestValue8();
         return result;
      }
      public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.Public GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestPendingChange()
      {
         ...
         // Construct new RPC client to test with.
         GrandpaControllerClient rpcClient = new GrandpaControllerClient(_httpClient, subscriptionClient);
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange mockupValue = this.GetTestValue4();
         ...
         Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletGrandpa.StoredPendingChange rpcResult = await rpcClient.GetPendingChange();
