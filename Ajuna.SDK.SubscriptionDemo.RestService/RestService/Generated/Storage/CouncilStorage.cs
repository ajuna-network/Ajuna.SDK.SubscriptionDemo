...
namespace Ajuna.SDK.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface ICouncilStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT4 GetProposals();
        
        /// <summary>
        /// >> ProposalOf
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall GetProposalOf(string key);
        
        /// <summary>
        /// >> Voting
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes GetVoting(string key);
        ...
        /// </summary>
        BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> GetMembers();
        
        /// <summary>
        /// >> Prime
        ///  The prime member that helps determine the default vote behavior in case of absentations.
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 GetPrime();
    }
    ...
    public sealed class CouncilStorage : ICouncilStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT4> _proposalsTypedStorage;
        
        /// <summary>
        /// _proposalOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall> _proposalOfTypedStorage;
        
        /// <summary>
        /// _votingTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes> _votingTypedStorage;
        ...
        /// </summary>
        private TypedStorage<BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>> _membersTypedStorage;
        
        /// <summary>
        /// _primeTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> _primeTypedStorage;
        ...
        {
            this.ProposalsTypedStorage = new TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT4>("Council.Proposals", storageDataProvider, storageChangeDelegate);
            this.ProposalOfTypedStorage = new TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall>("Council.ProposalOf", storageDataProvider, storageChangeDelegate);
            this.VotingTypedStorage = new TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes>("Council.Voting", storageDataProvider, storageChangeDelegate);
            ...
            this.MembersTypedStorage = new TypedStorage<BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>>("Council.Members", storageDataProvider, storageChangeDelegate);
            this.PrimeTypedStorage = new TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>("Council.Prime", storageDataProvider, storageChangeDelegate);
        }
        
        /// <summary>
        /// _proposalsTypedStorage property
        /// </summary>
        public TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT4> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall> ProposalOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes> VotingTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>> MembersTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> PrimeTypedStorage
        {
            get
            {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT4 GetProposals()
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall GetProposalOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalOfTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.AjunaSoloRuntime.EnumCall result))
            {
                return result;
            }
            else
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes GetVoting(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletCollective.Votes result))
            {
                return result;
            }
            else
        ...
        ///  The current members of the collective. This is stored sorted (just by value).
        /// </summary>
        public BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> GetMembers()
        {
        ...
        ///  The prime member that helps determine the default vote behavior in case of absentations.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 GetPrime()
        {
