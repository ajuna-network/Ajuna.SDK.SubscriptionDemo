...
namespace Ajuna.SDK.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>> GetAgenda(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>>> _agendaTypedStorage;
        ...
        {
            this.AgendaTypedStorage = new TypedMapStorage<BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>>>("Scheduler.Agenda", storageDataProvider, storageChangeDelegate);
        ...
        /// </summary>
        public TypedMapStorage<BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>>> AgendaTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>> GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out BaseVec<BaseOpt<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletScheduler.ScheduledV3>> result))
            {
                return result;
            }
            else
