...
namespace Ajuna.SDK.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal GetProposals(string key);
        
        /// <summary>
        /// >> Approvals
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 GetApprovals();
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal> _proposalsTypedStorage;
        
        /// <summary>
        /// _approvalsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5> _approvalsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, IStorageChangeDelegate storageChangeDelegate)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegate);
            this.ApprovalsTypedStorage = new TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5>("Treasury.Approvals", storageDataProvider, storageChangeDelegate);
        }
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5> ApprovalsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 GetApprovals()
        {
