...
using Ajuna.SDK.SubscriptionDemo.RestService.Formatters;
...
namespace Ajuna.SDK.SubscriptionDemo.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Ajuna.SDK.SubscriptionDemo.RestService", Version = "v1" });
         });
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ajuna.SDK.SubscriptionDemo.RestService v1");
             }
         );
