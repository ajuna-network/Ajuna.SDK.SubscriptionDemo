...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class DemocracyControllerMockupClient : MockupBaseClient, IDemocracyControllerMockupClient
   {
      ...
      public async Task<bool> SetPublicProps(BaseVec<BaseTuple<U32, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>> value)
      {
         return await SendMockupRequestAsync(_httpClient, "Democracy/PublicProps", value.Encode(), DemocracyStorage.PublicPropsParams());
      }
      public async Task<bool> SetDepositOf(BaseTuple<BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>, U128> value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Democracy/DepositOf", value.Encode(), DemocracyStorage.DepositOfParams(key));
      }
      public async Task<bool> SetPreimages(EnumPreimageStatus value, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
      ...
      public async Task<bool> SetVotingOf(EnumVoting value, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
      ...
      public async Task<bool> SetNextExternal(BaseTuple<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, EnumVoteThreshold> value)
      {
         return await SendMockupRequestAsync(_httpClient, "Democracy/NextExternal", value.Encode(), DemocracyStorage.NextExternalParams());
      }
      public async Task<bool> SetBlacklist(BaseTuple<U32, BaseVec<Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>> value, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Democracy/Blacklist", value.Encode(), DemocracyStorage.BlacklistParams(key));
      }
      public async Task<bool> SetCancellations(Bool value, Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
