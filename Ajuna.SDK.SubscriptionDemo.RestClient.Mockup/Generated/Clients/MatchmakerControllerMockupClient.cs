...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class MatchmakerControllerMockupClient : MockupBaseClient, IMatchmakerControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Matchmaker/Brackets", value.Encode(), Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletMatchmaker.MatchmakerStorage.BracketsParams(key));
      }
      public async Task<bool> SetPlayers(AccountId32 value, Ajuna.NetApi.Model.Types.Base.BaseTuple<U32, U32> key)
      {
         return await SendMockupRequestAsync(_httpClient, "Matchmaker/Players", value.Encode(), Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletMatchmaker.MatchmakerStorage.PlayersParams(key));
      }
      public async Task<bool> SetPlayerQueue(U8 value, AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Matchmaker/PlayerQueue", value.Encode(), Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletMatchmaker.MatchmakerStorage.PlayerQueueParams(key));
      }
   }
}
