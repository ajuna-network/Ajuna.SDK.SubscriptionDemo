...
namespace Ajuna.SDK.SubscriptionDemo.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TimestampControllerMockupClient : MockupBaseClient, ITimestampControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/Now", value.Encode(), Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTimestamp.TimestampStorage.NowParams());
      }
      public async Task<bool> SetDidUpdate(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/DidUpdate", value.Encode(), Ajuna.SDK.SubscriptionDemo.NetApi.Generated.Model.PalletTimestamp.TimestampStorage.DidUpdateParams());
      }
   }
}
