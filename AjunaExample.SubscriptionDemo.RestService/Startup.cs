...
using AjunaExample.SubscriptionDemo.RestService.Formatters;
...
namespace AjunaExample.SubscriptionDemo.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "AjunaExample.SubscriptionDemo.RestService", Version = "v1" });
         });
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "AjunaExample.SubscriptionDemo.RestService v1");
             }
         );
