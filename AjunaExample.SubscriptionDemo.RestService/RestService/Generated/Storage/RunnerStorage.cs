...
namespace AjunaExample.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface IRunnerStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState GetRunners(string key);
    ...
    public sealed class RunnerStorage : IRunnerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState> _runnersTypedStorage;
        ...
        {
            this.RunnersTypedStorage = new TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState>("Runner.Runners", storageDataProvider, storageChangeDelegate);
        ...
        /// </summary>
        public TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState> RunnersTypedStorage
        {
            get
            {
        ...
        ///  Stores a map of the runners with its configuration and state
        /// </summary>
        public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState GetRunners(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RunnersTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.SubscriptionDemo.NetApi.Generated.Model.AjunaCommon.EnumRunnerState result))
            {
                return result;
            }
            else
