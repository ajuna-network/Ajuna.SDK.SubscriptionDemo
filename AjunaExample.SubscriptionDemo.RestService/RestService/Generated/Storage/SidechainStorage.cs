...
namespace AjunaExample.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface ISidechainStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader GetLatestSidechainHeader(string key);
        
        /// <summary>
        /// >> SidechainHeaderQueue
        /// </summary>
        AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader GetSidechainHeaderQueue(string key);
    }
    ...
    public sealed class SidechainStorage : ISidechainStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader> _latestSidechainHeaderTypedStorage;
        
        /// <summary>
        /// _sidechainHeaderQueueTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader> _sidechainHeaderQueueTypedStorage;
        ...
        public SidechainStorage(IStorageDataProvider storageDataProvider, IStorageChangeDelegate storageChangeDelegate)
        {
            ...
            this.LatestSidechainHeaderTypedStorage = new TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader>("Sidechain.LatestSidechainHeader", storageDataProvider, storageChangeDelegate);
            this.SidechainHeaderQueueTypedStorage = new TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader>("Sidechain.SidechainHeaderQueue", storageDataProvider, storageChangeDelegate);
        }
        ...
        /// </summary>
        public TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader> LatestSidechainHeaderTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader> SidechainHeaderQueueTypedStorage
        {
            get
            {
        ...
        /// >> LatestSidechainHeader
        /// </summary>
        public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader GetLatestSidechainHeader(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LatestSidechainHeaderTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader result))
            {
                return result;
            }
            else
        ...
        /// >> SidechainHeaderQueue
        /// </summary>
        public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader GetSidechainHeaderQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SidechainHeaderQueueTypedStorage.Dictionary.TryGetValue(key, out AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SidechainPrimitives.SidechainHeader result))
            {
                return result;
            }
            else
