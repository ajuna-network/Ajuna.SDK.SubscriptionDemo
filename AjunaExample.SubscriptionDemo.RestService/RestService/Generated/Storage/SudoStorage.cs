...
namespace AjunaExample.SubscriptionDemo.RestService.Generated.Storage
{
    ...
    public interface ISudoStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 GetKey();
    }
    ...
    public sealed class SudoStorage : ISudoStorage
    {
        ...
        /// </summary>
        private TypedStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> _keyTypedStorage;
        ...
        {
            this.KeyTypedStorage = new TypedStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>("Sudo.Key", storageDataProvider, storageChangeDelegate);
        }
        
        /// <summary>
        /// _keyTypedStorage property
        /// </summary>
        public TypedStorage<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32> KeyTypedStorage
        {
            get
            {
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 GetKey()
        {
