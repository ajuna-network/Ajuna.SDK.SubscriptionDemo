...
namespace AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Proposals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal> Proposals(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            return await _client.GetStorageAsync<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal>(parameters, token);
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5> Approvals(CancellationToken token)
        {
            string parameters = TreasuryStorage.ApprovalsParams();
            return await _client.GetStorageAsync<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5>(parameters, token);
        }
    }
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method ProposeSpend(BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> value, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpRuntime.EnumMultiAddress beneficiary)
        {
