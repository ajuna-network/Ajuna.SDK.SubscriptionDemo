...
namespace AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTeerex
{
    ...
    public sealed class TeerexStorage
    {
        ...
        public TeerexStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Teerex", "EnclaveRegistry"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Teerex", "EnclaveIndex"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32), typeof(Ajuna.NetApi.Model.Types.Primitive.U64)));
        ...
        /// >> EnclaveRegistry
        /// </summary>
        public async Task<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave> EnclaveRegistry(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = TeerexStorage.EnclaveRegistryParams(key);
            return await _client.GetStorageAsync<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave>(parameters, token);
        }
        ...
        /// >> EnclaveIndexParams
        /// </summary>
        public static string EnclaveIndexParams(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
        {
        ...
        /// >> EnclaveIndex
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U64> EnclaveIndex(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key, CancellationToken token)
        {
        ...
        /// >> ExecutedCallsParams
        /// </summary>
        public static string ExecutedCallsParams(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
        {
        ...
        /// >> ExecutedCalls
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U64> ExecutedCalls(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key, CancellationToken token)
        {
    ...
    public sealed class TeerexCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method CallWorker(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Request request)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ConfirmProcessedParentchainBlock(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 block_hash, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 trusted_calls_merkle_root)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ShieldFunds(BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8> incognito_account_encrypted, Ajuna.NetApi.Model.Types.Primitive.U128 amount, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 bonding_account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnshieldFunds(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 public_account, Ajuna.NetApi.Model.Types.Primitive.U128 amount, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 bonding_account, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
