...
namespace AjunaExample.SubscriptionDemo.RestClient.Test.Generated
{
   ...
   public class GameRegistryControllerClientTest : ClientTestBase
   {
      ...
      public Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Primitive.U32> GetTestValue2()
      {
      ...
      [Test()]
      public async System.Threading.Tasks.Task TestQueued()
      {
         // Construct new Mockup client to test with.
         GameRegistryControllerMockupClient mockupClient = new GameRegistryControllerMockupClient(_httpClient);

         // Construct new subscription client to test with.
         var subscriptionClient = CreateSubscriptionClient();

         // Construct new RPC client to test with.
         GameRegistryControllerClient rpcClient = new GameRegistryControllerClient(_httpClient, subscriptionClient);
         Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Primitive.U32> mockupValue = this.GetTestValue2();


         Assert.IsTrue(await rpcClient.SubscribeQueued());

         // Save the previously generated mockup value in RPC service storage.
         bool mockupSetResult = await mockupClient.SetQueued(mockupValue);
         ...
         Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Primitive.U32> rpcResult = await rpcClient.GetQueued();
      ...
      public async System.Threading.Tasks.Task TestPlayers()
      {
         ...
         Ajuna.NetApi.Model.Types.Primitive.U32 rpcResult = await rpcClient.GetPlayers(mockupKey);
