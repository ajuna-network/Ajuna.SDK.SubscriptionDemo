...
namespace AjunaExample.SubscriptionDemo.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal GetTestValue3()
      {
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal result;
         result = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal();
         result.Proposer = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal mockupValue = this.GetTestValue3();
         ...
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletTreasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 GetTestValue7()
      {
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 result;
         result = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5();
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 mockupValue = this.GetTestValue7();
         ...
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.FrameSupport.BoundedVecT5 rpcResult = await rpcClient.GetApprovals();
