...
namespace AjunaExample.SubscriptionDemo.RestClient.Test.Generated
{
   ...
   public class TeerexControllerClientTest : ClientTestBase
   {
      ...
      public AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave GetTestValue2()
      {
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave result;
         result = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave();
         result.Pubkey = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32();
         result.Pubkey = this.GetTestValue3();
         result.MrEnclave = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.Base.Arr32U8();
         ...
         result.Url.Create(new Ajuna.NetApi.Model.Types.Primitive.U8[] {
                  this.GetTestValueU8()});
         result.SgxMode = new AjunaExample.SubscriptionDemo.NetApi.Generated.Model.IasVerify.EnumSgxBuildMode();
         result.SgxMode.Create(this.GetTestValueEnum<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.IasVerify.SgxBuildMode>());
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestEnclaveRegistry()
      {
         ...
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave mockupValue = this.GetTestValue2();
         ...
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.TeerexPrimitives.Enclave rpcResult = await rpcClient.GetEnclaveRegistry(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestEnclaveIndex()
      {
         ...
         TeerexControllerClient rpcClient = new TeerexControllerClient(_httpClient, subscriptionClient);
         Ajuna.NetApi.Model.Types.Primitive.U64 mockupValue = this.GetTestValueU64();
         AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 mockupKey = this.GetTestValue6();
