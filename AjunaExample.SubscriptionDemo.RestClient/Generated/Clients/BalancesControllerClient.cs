...
namespace AjunaExample.SubscriptionDemo.RestClient.Generated.Clients
{
   ...
   public sealed class BalancesControllerClient : BaseClient, IBalancesControllerClient
   {
      ...
      public async Task<AccountData> GetAccount(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendRequestAsync<AccountData>(_httpClient, "balances/account", BalancesStorage.AccountParams(key));
      }
      public async Task<bool> SubscribeAccount(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Balances.Account", BalancesStorage.AccountParams(key));
      }
      public async Task<WeakBoundedVecT3> GetLocks(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendRequestAsync<WeakBoundedVecT3>(_httpClient, "balances/locks", BalancesStorage.LocksParams(key));
      }
      public async Task<bool> SubscribeLocks(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Balances.Locks", BalancesStorage.LocksParams(key));
      }
      public async Task<BoundedVecT1> GetReserves(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT1>(_httpClient, "balances/reserves", BalancesStorage.ReservesParams(key));
      }
      public async Task<bool> SubscribeReserves(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
