...
namespace AjunaExample.SubscriptionDemo.RestClient.Generated.Clients
{
   ...
   public sealed class DemocracyControllerClient : BaseClient, IDemocracyControllerClient
   {
      ...
      public async Task<BaseVec<BaseTuple<U32, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>>> GetPublicProps()
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>>>(_httpClient, "democracy/publicprops");
      }
      public async Task<bool> SubscribePublicProps()
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.PublicProps");
      }
      public async Task<BaseTuple<BaseVec<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>, U128>> GetDepositOf(U32 key)
      {
         return await SendRequestAsync<BaseTuple<BaseVec<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>, U128>>(_httpClient, "democracy/depositof", DemocracyStorage.DepositOfParams(key));
      }
      ...
      public async Task<EnumPreimageStatus> GetPreimages(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendRequestAsync<EnumPreimageStatus>(_httpClient, "democracy/preimages", DemocracyStorage.PreimagesParams(key));
      }
      public async Task<bool> SubscribePreimages(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
      ...
      public async Task<EnumVoting> GetVotingOf(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
         return await SendRequestAsync<EnumVoting>(_httpClient, "democracy/votingof", DemocracyStorage.VotingOfParams(key));
      }
      public async Task<bool> SubscribeVotingOf(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32 key)
      {
      ...
      public async Task<BaseTuple<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, EnumVoteThreshold>> GetNextExternal()
      {
         return await SendRequestAsync<BaseTuple<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256, EnumVoteThreshold>>(_httpClient, "democracy/nextexternal");
      }
      public async Task<bool> SubscribeNextExternal()
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.NextExternal");
      }
      public async Task<BaseTuple<U32, BaseVec<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>>> GetBlacklist(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendRequestAsync<BaseTuple<U32, BaseVec<AjunaExample.SubscriptionDemo.NetApi.Generated.Model.SpCore.AccountId32>>>(_httpClient, "democracy/blacklist", DemocracyStorage.BlacklistParams(key));
      }
      public async Task<bool> SubscribeBlacklist(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.Blacklist", DemocracyStorage.BlacklistParams(key));
      }
      public async Task<Bool> GetCancellations(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
         return await SendRequestAsync<Bool>(_httpClient, "democracy/cancellations", DemocracyStorage.CancellationsParams(key));
      }
      public async Task<bool> SubscribeCancellations(AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PrimitiveTypes.H256 key)
      {
