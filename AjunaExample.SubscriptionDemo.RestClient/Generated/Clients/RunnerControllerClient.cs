...
namespace AjunaExample.SubscriptionDemo.RestClient.Generated.Clients
{
   ...
   public sealed class RunnerControllerClient : BaseClient, IRunnerControllerClient
   {
      ...
      {
         return await SendRequestAsync<EnumRunnerState>(_httpClient, "runner/runners", AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletRunner.RunnerStorage.RunnersParams(key));
      }
      public async Task<bool> SubscribeRunners(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Runner.Runners", AjunaExample.SubscriptionDemo.NetApi.Generated.Model.PalletRunner.RunnerStorage.RunnersParams(key));
      }
